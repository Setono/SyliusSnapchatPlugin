...
use Setono\SyliusSnapchatPlugin\Doctrine\ORM\PixelRepository;
use Setono\SyliusSnapchatPlugin\Form\Type\PixelType;
use Setono\SyliusSnapchatPlugin\Model\Pixel;
...
final class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('setono_sylius_snapchat');
